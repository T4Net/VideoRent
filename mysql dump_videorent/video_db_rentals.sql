...
CREATE TABLE `rentals` (
  ...
  `dateDueBack` datetime DEFAULT NULL,
  `returnDate` datetime DEFAULT NULL,
  `hireCost` double DEFAULT NULL,
  `memberID` int(11) NOT NULL,
  UNIQUE KEY `movieIDCopy_UNIQUE` (`movieIDCopy`),
  UNIQUE KEY `memberID_UNIQUE` (`memberID`),
  CONSTRAINT `copyID` FOREIGN KEY (`movieIDCopy`) REFERENCES `movie_copies` (`movieIDCopy`) ON DELETE NO ACTION ON UPDATE NO ACTION
